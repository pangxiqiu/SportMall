...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form" id="addProduct" action="<%=basePath%>back/addProductInfo.do" method="post" enctype="multipart/form-data">
        <div class="layui-form-item">
            <label  class="layui-form-label"><span class="x-red">*</span>产品名称</label>
            <div class="layui-input-inline">
                <input type="text" id="pname" name="pname" lay-verify="required|nikename" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input class="layui-input" id="vender" lay-verify="required|nikename" name="vender" placeholder="" />
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>必填项
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input class="layui-input" id="pubdate" name="pubdate" placeholder="yyyy-MM-dd">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input class="layui-input" id="price" lay-verify="required|price" name="price" placeholder="￥0.00" />
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>必填项
                </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea id="pdesc" name="pdesc"  placeholder="请输入内容" class="layui-textarea"></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input class="layui-input" lay-verify="required|count" id="count" name="count" placeholder="" />
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>必填项
                </div>
        ...
        <div class="layui-form-item">
            ...
            <button class="layui-btn" lay-submit="" lay-filter="add_demo">添加</button>
...
<script>
    layui.use(['laydate','form', 'layer','upload'], function() {
        ...
        form.on('submit(add_demo)', function(data) {
            ...
            // var pname = document.getElementById("pname").val();
            // var pubdate = document.getElementById("pubdate").val();
            // var price = document.getElementById("price").val();
            // var count = document.getElementById("count").val();
            // var pic_file = document.getElementById("pic");
            // var pic = pic_file.files[0];
            // var pic1_file = document.getElementById("pic1");
            // var pic1 = pic1_file.files[0];
            // var pic2_file = document.getElementById("pic2");
            // var pic2 = pic2_file.files[0];
