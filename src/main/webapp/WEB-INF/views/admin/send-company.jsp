    ...
    <form class="layui-form"  action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input  type="text" name="ono" id="ono" value="${ono}" style="display: none">
               <c:forEach items="${list}" var="com">
                   <input  type="radio" name="cname" id="cname" value="${com.cname}" title="${com.cname}" checked>
               </c:forEach>
                <%--<input type="radio" name="cname" id="cname" value="1" title="asd">--%>
            </div>
        </div>
...
<script>
    layui.use(['form', 'layer','laypage'], function() {
        ...
        form.on('submit(edit_demo)', function(data){
            var ono = $("#ono").val();
            var com =  $("input[name='cname']:checked").val();
            // alert(ono);
            // alert(com);
            ...
            layer.confirm('确认发货吗？', function(index){
                ...
                $.ajax({
                    type : "POST",
                    url :'<%=basePath%>Order/updateOstate.do',
                    data : {
                        "ono":ono,
                        "cname":com,
                    },
